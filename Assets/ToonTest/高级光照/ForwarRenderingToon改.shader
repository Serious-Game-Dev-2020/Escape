...
Shader "Unity Shaders Book/Chapter 6/ForwardRenderingToon"
{
    Properties
    {
    ...
    SubShader
    {
        pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                return fixed4(ambient + diffuse + smoothSpecular, 1.0); 
            }
        ...
        pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                fixed3 specular = _LightColor0 * _Specular * pow(max(0,dot(worldNormal, halfDir)), _Gloss);
                fixed3 smoothSpecular = smoothstep(0.01, 0.02, specular);
                return fixed4((diffuse +  smoothSpecular)*atten, 1.0); 
            }
